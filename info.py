...
SHORTENER_API = os.environ.get('SHORTENER_API', "2288e41c1a5e11d86bed59322bc5fdee1a2cae0b")
ADMINS = int(os.environ.get("ADMINS", "1030335104"))
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://ttttechnicalaks7:testdburl@cluster0.sf7sluy.mongodb.net/?retryWrites=true&w=majority")
