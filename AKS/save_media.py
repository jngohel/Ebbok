...
async def save_media_in_channel(bot: Client, editable: Message, message: Message):
    try:
        ...
        link = f"https://telegram.me/{BOT_USERNAME}?start=Aks_{str_to_b64(str(file_er_id))}"
        tg_link = await db.get_shortlink(user, link)
        ...
        btn=[[
            ...
            InlineKeyboardButton("ᴛᴇʟᴇɢʀᴀᴍ ꜰɪʟᴇ", url=tg_link)
        ]]
