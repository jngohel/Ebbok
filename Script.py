class script(object):
  ...
  START_TEXT = """<b>ᴛʜɪꜱ ɪꜱ ꜰɪʟᴇ,ᴠɪᴅᴇᴏꜱ ꜱᴀᴠᴇʀ ʙᴏᴛ. ꜱᴇɴᴅ ᴍᴇ ᴀɴʏ ꜰɪʟᴇ, ᴠɪᴅᴇᴏꜱ, ɪᴍᴀɢᴇꜱ, ᴀᴜᴅɪᴏ ᴏʀ ᴀ ᴘᴏꜱᴛ ɪ ᴡɪʟʟ ɢɪᴠᴇ ʏᴏᴜ ᴀ ꜱʜᴀʀᴀʙʟᴇ ʟɪɴᴋ. ʏᴏᴜ ᴄᴀɴ ᴍᴀᴋᴇ ᴍᴏɴᴇʏ ʙʏ ꜱʜᴀʀɪɴɢ ᴛʜᴀᴛ ʟɪɴᴋ.
